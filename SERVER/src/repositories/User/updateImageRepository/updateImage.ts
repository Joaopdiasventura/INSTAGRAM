import { IUpdateImageRepository, UpdateImageParams } from "../../../controllers/User/updateImageController/protocols";
import { Message } from "../../../controllers/protocols";
import User from "../../../models/user";
import prisma from "../../../services/prisma";
import { AddImage, UpdateImage } from "../../../controllers/User/updateImageController/updateFile";
    ...
    async update(params: UpdateImageParams): Promise<User | Message> {
        ...
        try {
            ...
            if (user.picture == "https://icones.pro/wp-content/uploads/2021/02/icono-de-camara-gris.png") {
                ...
                user.picture = (await prisma.user.findFirst({where: {email: params.email}})).picture;
            }
            else{
