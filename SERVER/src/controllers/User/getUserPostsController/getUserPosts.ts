...
export class GetUserPostsController implements IController {
    constructor(private readonly getUserPostsRepository: IGetUserPostsRepository){}
    async handle(request?: HttpRequest<GetUserPostsParams>): Promise<HttpResponse<Post[]>> {
